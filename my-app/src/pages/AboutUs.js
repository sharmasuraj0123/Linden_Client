...
class AboutUs extends Component {
    render() {
        ...
        <div style={{ paddingTop:'1em' }}>
            <Divider horizontal style={{ fontSize:'2.5em'}}> ABOUT LINDEN ®</Divider>
            ...
            <Divider horizontal style={{ fontSize:'2.5em'}}> LindoMeter</Divider>
            <p style={{ fontSize:'16px'}}>
            ...
            <Divider horizontal style={{ fontSize:'2.5em'}}> Verfied Fall</Divider>
            <Divider horizontal style={{ fontSize:'2.5em'}}> Score</Divider>
            <Divider horizontal style={{ fontSize:'2.5em'}}> Audience Score</Divider>
