...
var PanelBar = /** @class */ (function (_super) {
    ...
    function PanelBar(props) {
        ...
        _this.handleSelect = function (event) {
            _this._selectionService.select(event.uniquePrivateKey, util_1.renderChildren(_this.props.animation, _this.state, _this.handleSelect, _this.props.children), _this.state.expanded);
            _this._selectionService.focus(event.uniquePrivateKey, 0, util_1.renderChildren(_this.props.animation, _this.state, _this.handleSelect, _this.props.children));
        };
        /**
         * @hidden
         */
        ...
        _this.onNavigate = function (action) {
            switch (action) {
                case navigationService_1.NavigationAction.Previous:
                    _this._selectionService.focus(_this.state.focused, -1, util_1.renderChildren(_this.props.animation, _this.state, _this.handleSelect, _this.props.children));
                    break;
                case navigationService_1.NavigationAction.Next:
                    _this._selectionService.focus(_this.state.focused, 1, util_1.renderChildren(_this.props.animation, _this.state, _this.handleSelect, _this.props.children));
                    break;
                case navigationService_1.NavigationAction.Toggle:
                    _this._selectionService.select(_this.state.focused, util_1.renderChildren(_this.props.animation, _this.state, _this.handleSelect, _this.props.children), _this.state.expanded);
                    break;
                default:
            }
        };
    ...
    PanelBar.prototype.render = function () {
        ...
        var children = util_1.renderChildren(this.props.animation, this.state, this.handleSelect, this.props.children);
        return (React.createElement("div", __assign({ ref: function (div) { _this._element = div; }, dir: this.props.dir, role: "tree", tabIndex: 0, onKeyDown: this.handleKeyDown, onFocus: this.handleWrapperFocus, onBlur: this.handleWrapperFocus, className: "k-widget k-panelbar k-reset k-header" }, ariaProps), children));
    };
    /**
     * @hidden
     */
