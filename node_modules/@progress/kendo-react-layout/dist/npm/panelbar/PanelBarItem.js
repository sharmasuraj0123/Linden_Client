...
var PanelBarItem = /** @class */ (function (_super) {
    ...
    PanelBarItem.prototype.render = function () {
        var _a = this.props, id = _a.id, children = _a.children, title = _a.title, uniquePrivateKey = _a.uniquePrivateKey, disabled = _a.disabled, selected = _a.selected, focused = _a.focused, expanded = _a.expanded, className = _a.className, root = _a.root, headerClassName = _a.headerClassName, animation = _a.animation;
        ...
        var panelBarItemArrowClassName = kendo_react_common_1.classNames((_b = {},
            _b['k-icon'] = true,
            _b['k-i-arrow-n'] = expanded && !!children,
            _b['k-panelbar-collapse'] = expanded && !!children,
            _b['k-i-arrow-s'] = !expanded && !!children,
            _b['k-panelbar-expand'] = !expanded && !!children,
            _b));
        var animationStyle = { position: 'static' };
